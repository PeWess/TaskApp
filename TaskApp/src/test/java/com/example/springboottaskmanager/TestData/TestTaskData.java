...
public class TestTaskData {
    ...
    static public List<Task> goodTasks = new ArrayList<>(Arrays.asList(fullWrittenTask, onlyImportantParams));
    static public List<Task> badTasks = new ArrayList<>(Arrays.asList(smallTaskNameTask, emptyTask));
}
